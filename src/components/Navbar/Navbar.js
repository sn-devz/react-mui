...
import { makeStyles, AppBar, Toolbar, IconButton, Typography, Drawer, Box } from '@material-ui/core';
        ...
        <div>
            <AppBar position='fixed' className={classes[navRef.current]} >
                <Toolbar>
                    ...
                    <Box display='flex' marginLeft='auto' className={classes.toggleDrawer}>
                        <div>
                            <IconButton
                            aria-label="Menu"
